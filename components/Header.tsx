...
<header>
  ...
  <div className='absolute top-0 left-0 bg-gradient-to-br from-pink-400 to-[#0055D1] w-full h-96 rounded-md filter blur-3xl opacity-50 -z-50 '/>   
  ...
  <div className="flex items-center space-x-5 flex-1 justify-end w-full " >
    ...
    <Avatar name="Steve Daniel " size="40" round={true} color = "#0055D1" />
  </div>
  </div>
